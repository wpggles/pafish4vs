...
#include "PafishAssembly/types.h"
#include "PafishAssembly/config.h"
#include "PafishAssembly/common.h"

#include "PafishAssembly/debuggers.h"
#include "PafishAssembly/sandboxie.h"
#include "PafishAssembly/gensandbox.h"
#include "PafishAssembly/hooks.h"
#include "PafishAssembly/vbox.h"
#include "PafishAssembly/wine.h"
#include "PafishAssembly/vmware.h"
#include "PafishAssembly/qemu.h"
#include "PafishAssembly/cpu.h"
#include "PafishAssembly/bochs.h"

#ifndef _WIN64
#include "PafishAssembly/cuckoo.h"
#endif

/*
   Pafish4vs based on Pafish.
   Just ported to the VS (VC) compiler (X64, X86) 
   and did not do functional changes.
*/
/*
...
#ifdef _WIN64
    print_check_group("Cuckoo detection (Win64 not supported)");
#else
